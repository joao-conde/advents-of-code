...
# PART 2
min_delay = 0
while 0 in [(ps + min_delay) % (2 * (layers_dict[ps] - 1)) for ps in range(max_ps + 1) if ps in layers_dict]: min_delay += 1
print("(Part2) Fewest packet delay to pass through the firewall:", min_delay)
